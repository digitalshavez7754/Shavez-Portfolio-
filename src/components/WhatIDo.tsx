        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>MOTION & VIDEO</h3>
              <h4>Cinematic Visual Storytelling</h4>
              <p>
                Crafting engaging, high-quality video content and dynamic motion graphics. 
                From pacing and transitions to color grading, I ensure every frame captivates.
              </p>
          ...
          >
            ...
            <div className="what-corner"></div>
            <div className="what-content-in">
              <h3>GENERATIVE AI & DESIGN</h3>
              <h4>AI-Driven Creative Concepts</h4>
              <p>
                Utilizing state-of-the-art AI generation tools alongside traditional design 
                software to conceptualize and craft visually stunning and innovative artwork.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Topaz Video AI</div>
